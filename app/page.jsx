...
export default function Home() {
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-20 ">
      ...
      <section id="features" className="bg-gray-50 py-20">
        <div className="container mx-auto px-4 md:px:6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-[700px] text-gray-500 md:text-xl/relaxed">
            One platform provides all the tools you need to handle shared
            expenses with area.
          </p>
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4 md:px:6 text-center">
          ...
          <h2 className=" gradient-title mt-2 text-3xl md:text-4xl">
            Spliting expenses has never been easier
          </h2>
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          ...
          <p className="mx-auto max-w-[600px] text-green-100 md:text-xl/relaxed">
            Join thousands of user who have made splitting expenses
            stress-free{" "}
          </p>
          <Button
            asChild
