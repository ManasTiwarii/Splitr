...
const ContactsPage = () => {
  ...
  return (
    <div className=" px-8 container mx-auto py-6">
      <div className="pt-20 px-4 flex items-center justify-between mb-6">
        {/* Push content below navbar // */}
        <h1 className="text-5xl gradient-title mb-4">Contacts</h1>
        ...
        <div>
          ...
          {users.length === 0 ? (
            ...
            <div className="flex flex-col gap-4">
              {users.map((user) => (
                <Link key={users.id} href={`/person/${user.id}`}>
